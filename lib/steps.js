...
/*
Pass through function only
*/
exports.unzip = function (file, destination, callback) {

	var unzipLib = require("./unzip.js");
	  
	unzipLib.unzip(file, destination, function(err, files){
		console.log(files);
		callback(err,files);		
	});	
};