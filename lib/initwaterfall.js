...
function createDBContainer(config, country, previousStatus, callback){
	callback(null, "{\"status\": \"false\", \"file\": \"" + null + "\", \"error\": \"" + "to be implemented" + "\"}");
};
function importTSV(config, country, previousStatus, callback){
	callback(null, "{\"status\": \"false\", \"file\": \"" + null + "\", \"error\": \"" + "to be implemented" + "\"}");
};
